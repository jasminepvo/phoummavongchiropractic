		...
		<div className="services">
			<section className="services-left">
				...
				<div className="services-paragraph">
					<p>
						Phoummavong Chiropractic & Wellness strives to provide preventative
						health care measures with holistic treatments such as adjustments,
						myofascial release and electric stim therapy.{" "}
					</p>
					<p>
						Through chiropractic and a personalized health care plan, Dr.
						Phoummavong will help you reach your optimal health and wellness
						goals.
					</p>
				</div>
			</section>
			<section className="services-right">
				<div className="service">
					...
					<div>
						...
						<p className="service-description">
							Realign your spine using safe, non-invasive techniques:
							Diversified, Thompson, instruments.
						</p>
					</div>
				</div>
				<div className="service">
					...
					<div>
						...
						<p className="service-description">
							Application of rehab exercises and stretches to promote optimal
				...
				<div className="service">
					...
					<div>
						...
						<p className="service-description">
							Fine tune performance, prevent injuries, and speed up recovery
							times.
						</p>
					</div>
				</div>
				<div className="service">
					...
					<div>
						...
						<p className="service-description">
							Reduce pain by improving mobility & relax tight fascia while
				...
				<div className="service">
					...
					<div>
						...
						<p className="service-description">
							Application of electrical currents to promote proprioception and
				...
				<div className="service">
					...
					<div>
						...
						<p className="service-description">
							Customized care plans for each individual patients that address
							your goals.
						</p>
					</div>
				</div>
